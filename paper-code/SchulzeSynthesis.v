...
Section Count.
  ...
  Proof.
    ...
    pose proof (fin bs _ bs' (c_wins m) (wins_loses_M cand_fin dec_cand cand_not_nil m) X).
    pose proof (X0 (winner_one cand_fin dec_cand cand_not_nil m)
                   (loser_one cand_fin dec_cand cand_not_nil m)).
