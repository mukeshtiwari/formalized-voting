...
/* package schulze-new-voting-0.1.0.0 */
#define VERSION_schulze_new_voting "0.1.0.0"
#define MIN_VERSION_schulze_new_voting(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "schulze-new-voting-0.1.0.0-Fk8Ee6s6xAoLTsjn1GNMj"

#define CURRENT_PACKAGE_KEY "schulze-new-voting-0.1.0.0-Fk8Ee6s6xAoLTsjn1GNMj"
